...
| wiki_path | string | "~/.outobot/wiki" | Directory for wiki markdown files |
| max_results | int | 5 | Maximum number of memory results to retrieve |
...
- `outowiki` Python library
- LLM provider with API key configured
